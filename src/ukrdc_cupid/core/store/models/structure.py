...
class Node(ABC):
    ...
    def get_orm_list(self, is_dirty:bool = False, is_new:bool = True, is_unchanged:bool = False):
        ...
        if self.mapped_classes:
            for child_class in self.mapped_classes:
                orm_objects = orm_objects + child_class.get_orm_list(is_dirty, is_new, is_unchanged)
