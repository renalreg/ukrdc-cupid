...
def create_ambiguous_feed(patients:tuple):
    print("placeholder function for investigation into ambigious patient matches to local feed")
    return "my_sqla_model_2"
...
def create_ambiguous_ukrdc(pid:str):
    print("placeholder function for investigation into ambigious ukrdc patient matches")
    return "my_sqla_model_4"