...
@pytest.mark.skipif(not should_run_locally(), reason="Test requires live renalreg database connection")
def test_load_modality_codes(renalreg_session:Session, ukrdc_test_session_persistent:Session):
